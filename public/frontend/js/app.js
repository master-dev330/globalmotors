...
ocean_option.forEach(el => {
  ...
  const instance = new SlimSelect({
    ...
    showSearch: isMultiple || hasSearch,
    onChange: (info) => {
      var ocean_fee = $('.test_data_'+info.value).attr("data-fee");
      var ocean_fee =  $('.ocean_fee').html(ocean_fee);
      var unit_ocean_fee = $('.ocean_fee').html();
      var unit_ground_fee = $('.ground_fee').html();
      var total_fee = parseInt(unit_ground_fee) + parseInt(unit_ocean_fee);
      $('.total_cost_price').html(total_fee);
      // filter();
         // $.ajax({
         //        type: "get",
...
shipping.forEach(el => {
  ...
  const instance = new SlimSelect({
    ...
    showSearch: isMultiple || hasSearch,
    onChange: (info) => {
           var reocean= $(".ocean_fee").html('');
           var reground= $(".ground_fee").html();
