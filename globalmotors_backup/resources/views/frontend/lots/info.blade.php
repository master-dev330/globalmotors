                      ...
                      <div class="card-body">
                        <dl class="details-list">
                          ...
                          <dd>{{$data['lot']->transmission}}</dd>
                           ...
                           <dt><img src="{{asset('frontend/images/icon/wheel-alignment-icon.png')}}" alt="">@lang('lotdetail.Drivetrain')</dt>
                          <dd>{{$data['lot']->drivelineType}}</dd>
