  ...
  <input type="hidden" name="start_date" value="{{isset($data['trading_date'])?strtotime($data['trading_date']):0}}">
          ...
          <div class="row">
                        ...
                        <div class="details-list">
                          ...
                          <div class="details-list__item1 mb-3">
                            <p class="details-list__label color_green" style="border-radius: 0px !important; color:#0f886f ">@lang('lotdetail.sale_man'): 
                             <dd class="m-0 details-list__label color_green" style="border-radius: 0px !important ;display: contents;"><p style="color:#0f886f">{{$data['lot']->seller}} </p></dd>

                          
                          </div>
                          <div class="details-list__item mb-1 trading-date__item">
                            <p class="color_black"><img src="{{asset('frontend/images/icon/calendar-week-icon.png')}}" alt=""><span>{{isset($data['lot']->trading_date) ? $data['lot']->trading_date:''}}</span></p>
                            <span data-toggle="popover" data-trigger="hover" class="card-block__trading_date number p-1" rel="tooltip" data-content="You can change timezone settings in your profile.
                      ...
                      <div class="card-body">
                        <dl class="details-list">
                          ...
                          <dd>{{$data['lot']->secondary_damage}}</dd>
                           ...
                           <dt><img src="{{asset('frontend/images/icon/car-crash-icon.png')}}" alt="">@lang('lotdetail.Condition')</dt>
                          <dd>
                          @if($data['lot']->vehicleCondition=='wont-start')
                             {{$data['lot']->vehicleCondition}}
                            @elseif($data['lot']->vehicleCondition=='starts')
                            Engine {{$data['lot']->vehicleCondition}}
            ...
            <div class="col-xl-5">
              <div class="card card-product padding-none card-info-rate-timer_wrapper">
                    ...
                    <button data-toggle="modal" data-target="#modal-rate" class="btn btn-blue btn__big mb-2">
                    ...
                    @endif
                      ...
                      <div class="card-info-rate__bottom">
                          <div class="card-info-rate__bottom-item">
                            <span style="width:113px">@lang('lotdetail.actual_cash_value'):</span>
                            <span style="width:100px"><strong>${{$data['lot']->est_retail_value}} USD</strong></span>
                          </div>
                          <div class="card-info-rate__bottom-item">
                            <span>@lang('lotdetail.sale_status'):</span>
                            <span><strong>
                            <span><strong>{{$data['lot']->sold==true ? 'Sold' : 'N/A'}} </strong></span>
                              ...
                              <p class="title-p mt-4 delivery1">
                               ...
                               <div class="card-body-row card-product__select delivery">
                                <div class="select mb-3">
                                  <select class="slim-select-2 testshipping" data-shipping name="id" >
