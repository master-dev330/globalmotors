...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item returndeposit "><a class="d-flex align-items-center" href="{{url(app()->getLocale().'/admin/returndeposits')}}"><i data-feather='dollar-sign'></i><span class="menu-title text-truncate">@lang('main_navigation.Return_deposit')</span></a>
            </li>  
