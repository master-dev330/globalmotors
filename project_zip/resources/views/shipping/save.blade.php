...
@section('breadcrumb')
    ...
    <h2 class="content-header-title float-left mb-0">@lang('shipping.shipping')</h2>

    <div class="breadcrumb-wrapper">

        <ol class="breadcrumb">

            <li class="breadcrumb-item"><a href="{{url(app()->getLocale().'/admin/view_shippment')}}">@lang('shipping.shipping')</a>
        ...
        <section id="basic-input">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url(app()->getLocale().'/admin/saveshipping')}}" class="" id="form_submit" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('shipping.title')</label>
                                    <input type="text" name="title" class="form-control" value="{{(isset($data['results']->title) ? $data['results']->title : '')}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>@lang('shipping.zip_code')</label>
                                    <input type="text" name="zip_code" class="form-control" value="{{(isset($data['results']->zip_code) ? $data['results']->zip_code : '')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary">@lang('shipping.save')</button>
                                </div>
                            </div>
                        </div>
                    </form>
