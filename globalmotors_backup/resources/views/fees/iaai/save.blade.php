...
@section('breadcrumb')
    ...
    <h2 class="content-header-title float-left mb-0">@lang('copart.iaai')</h2>

    <div class="breadcrumb-wrapper">

        <ol class="breadcrumb">

            <li class="breadcrumb-item"><a href="{{url(app()->getLocale().'/admin/iaais')}}">@lang('copart.iaai')</a>
        ...
        <section id="basic-input">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url(app()->getLocale().'/admin/saveiaai')}}" class="" id="form_submit" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <select class="form-control main_cat" name="sub_type" data-option-id="{{(isset($data['results']->sub_type) ? $data['results']->sub_type : '')}}">
                                        ...
                                        <option value="BuyerFee">IAAI Buyer Fee</option>
                                        <option value="Virtualbed">Internet Bed</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 iaai_standard">
                                <div class="form-group">
                             ...
                             <div class="col-md-4 iaai_standard">
                                <div class="form-group">
                                    <label>@lang('copart.heavy_vechile')</label>
                                    <input type="text" name="heavy_fee" class="form-control" value="{{(isset($data['results']->heavy_fee) ? $data['results']->heavy_fee : '')}}">
                                </div>
                            </div>
                            <div class="col-md-4 iaai_standard1">
                                <div class="form-group">
                        ...
                        <input type="hidden" name="type" class="form-control" value="iaai">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('.iaai_standard').addClass('d-none');
        $('.iaai_standard1').addClass('d-none');

     $(document).ready(function() {

        $('.feemgt').addClass('sidebar-group-active');
        $('.iaai').addClass('active');
        ...
        $(document).on('change','.main_cat',function(){
            ...
            if(select=="BuyerFee")
            {
                $('.iaai_standard').removeClass('d-none');
                $('.iaai_standard1').addClass('d-none');
                
            }
            else if(select=="Virtualbed")
            {
                $('.iaai_standard1').removeClass('d-none');
                $('.iaai_standard').addClass('d-none');
            }
