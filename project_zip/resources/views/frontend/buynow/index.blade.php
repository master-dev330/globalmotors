									...
									<div class="card-tabs">
										...
										<nav>
											...
											<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
												...
												<a class="nav-item nav-link" id="nav-3-tab" data-toggle="tab" href="#nav-3" role="tab" aria-controls="nav-3-tab" aria-selected="false">@lang('betting.decline')</a>
										...
										<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
											...
											<div class="tab-pane fade  show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab">
                                               ...
                                               @include('frontend.buynow.current')

					                        </div>

					                        <div class="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab">

                                               @include('frontend.buynow.purchased')

					                        </div>

					                        <div class="tab-pane fade" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab">

                                               @include('frontend.buynow.rejected')

					                        </div>

					                        <div class="tab-pane fade" id="nav-4" role="tabpanel" aria-labelledby="nav-4-tab">

					                         @include('frontend.buynow.cancelled')
