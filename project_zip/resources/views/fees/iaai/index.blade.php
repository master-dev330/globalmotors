                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header border-bottom">
                                    ...
                                    <h4 class="card-title">@lang('copart.iaai')</h4>

                                    <a class="btn btn-primary" href="{{url(app()->getLocale().'/admin/iaai')}}">@lang('copart.add_iaai')</a>
                                    ...
                                    <table class="table dynamic_table  font-weight-bold table-responsive">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                              ...
                                              <th>@lang('copart.heavy_vechile')</th>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{url(app()->getLocale().'/admin/iaai/'.$row->id)}}">
                                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                                    <span>@lang('copart.edit')</span>
                                                                </a>
                                                                <a data-href="{{url(app()->getLocale().'/admin/deleteiaai/'.$row->id)}}"  data-toggle="modal" data-target="#confirm-delete" class="dropdown-item" href="javascript:void(0);">
